...
const ModuleSchema = z.enum(["features"]);
...
export const schema = z
  .object({
    ...
    description: z
      .string()
      .min(1, { message: "description must have at least 3 characters" })
      .max(191, { message: "description must have max 191 characters" })
      .regex(regexString, { message: "Invalid description format" })
      .optional()
      .or(z.literal("")),
  })
