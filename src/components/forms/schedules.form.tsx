...
import { schedulesAction, schedulesValidation } from "@/actions/schedules.actions";
...
export function ModuleForm({
  ...
  const handleSubmit = async () => {
    ...
    const result = await schedulesValidation(fd, locale);
    if (result) {
      setErrors(result);
      toast.error(api, {
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Input
              ...
              className="border-blue-400 bg-background appearance-none [&::-webkit-calendar-picker-indicator]:hidden"
            />
