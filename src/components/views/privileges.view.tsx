      ...
      <AlertDialogContent className="max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          {[
            ...
            ["create", data?.privilegeCreate ? t("active") : t("inactive")],
            ["read", data?.privilegeRead ? t("active") : t("inactive")],
            ["update", data?.privilegeUpdate ? t("active") : t("inactive")],
            ["delete", data?.privilegeDelete ? t("active") : t("inactive")],
