...
import { ModuleForm } from "@/components/forms/users.form";
import { format } from "date-fns";
import { useTranslations } from "next-intl";
import { ModuleView } from "@/components/views/users.view";
...
export default function UsersPage() {
  ...
  const columns: TableKeyType[] = [
    ...
    { key: "photo", label: t("photo"), sort: false, isImage: true, isFile: false },
    { key: "name", label: t("name"), sort: true, isImage: false, isFile: false },
    { key: "email", label: t("email"), sort: true, isImage: false, isFile: false },
    { key: "phone", label: t("phone"), sort: false, isImage: false, isFile: false },
    { key: "address", label: t("address"), sort: false, isImage: false, isFile: false },
