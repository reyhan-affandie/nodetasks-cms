...
import { ApiPayload, SubModules, TableKeyType } from "@/types/apiResult.type";
import { ModuleForm } from "@/components/forms/roles.form";
import { format } from "date-fns";
import { useTranslations } from "next-intl";
import { ModuleView } from "@/components/views/roles.view";
...
export default function RolesPage() {
  ...
  const columns: TableKeyType[] = [
    ...
    { key: "status", label: t("status"), sort: true, isImage: false, isFile: false },
