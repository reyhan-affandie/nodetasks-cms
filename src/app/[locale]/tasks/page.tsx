...
export default function TasksPage() {
  ...
  const [sort, setSort] = useState("priority.name");
  ...
  const columns: TableKeyType[] = [
    ...
    { key: "priority.name", label: t("priority"), sort: true, isImage: false, isFile: false },
    { key: "phase.name", label: t("phase"), sort: true, isImage: false, isFile: false },
  ];
